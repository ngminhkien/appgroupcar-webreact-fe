...
const CompanyVehicleTable = ({ vehicles, isLoading, pagination, onGoToPage, onViewDetail, onDelete }) => {
      ...
      <table className="w-full min-w-[1000px] border-collapse">
        ...
        <tbody>
          {vehicles.map((v, index) => (
            <tr key={v.companyVehicleId || index} className="hover:bg-slate-50 transition-colors cursor-pointer group" onClick={() => onViewDetail && onViewDetail(v)}>
