      ...
      >
        ...
        <div className="px-6 py-2">
          <p className="text-slate-600">
            Bạn có chắc chắn muốn mở khóa công ty <span className="font-bold text-slate-900">{companyName}</span>?
          </p>
          <p className="mt-2 text-sm text-slate-500 leading-relaxed">
            Hành động này sẽ khôi phục trạng thái hoạt động của công ty này trên hệ thống.
          </p>
        </div>
