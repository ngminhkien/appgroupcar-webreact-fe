      ...
      >
        ...
        <div className="px-6 py-2">
          <p className="text-slate-600">
            Bạn có chắc chắn muốn xóa công ty <span className="font-bold text-slate-900">{companyName}</span>?
          </p>
          <p className="mt-2 text-sm text-slate-500 leading-relaxed">
            Hành động này không thể hoàn tác. Tất cả dữ liệu liên quan đến công ty này sẽ bị gỡ bỏ vĩnh viễn khỏi hệ thống.
          </p>
        </div>
