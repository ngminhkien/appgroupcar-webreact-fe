      ...
      >
        ...
        <div className="px-6 py-2">
          <p className="text-slate-600">
            Bạn có chắc chắn muốn mở khóa phương tiện biển số <span className="font-bold text-slate-900 font-mono">{plateNumber}</span>?
          </p>
          <p className="mt-2 text-sm text-slate-500 leading-relaxed">
            Hành động này sẽ khôi phục trạng thái hoạt động của phương tiện này trên hệ thống.
          </p>
        </div>
