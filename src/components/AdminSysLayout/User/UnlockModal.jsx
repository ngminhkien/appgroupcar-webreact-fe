      ...
      >
        ...
        <div className="px-6 py-2">
          <p className="text-slate-600">
            Bạn có chắc chắn muốn mở khóa người dùng <span className="font-bold text-slate-900">{userName}</span>?
          </p>
          <p className="mt-2 text-sm text-slate-500 leading-relaxed">
            Hành động này sẽ khôi phục lại trạng thái hoạt động và quyền truy cập của người dùng này vào hệ thống.
          </p>
        </div>
