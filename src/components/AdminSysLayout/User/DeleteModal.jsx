      ...
      >
        ...
        <div className="px-6 py-2">
          <p className="text-slate-600">
            Bạn có chắc chắn muốn khóa người dùng <span className="font-bold text-slate-900">{userName}</span>?
          </p>
          <p className="mt-2 text-sm text-slate-500 leading-relaxed">
            Hành động này sẽ tạm ngưng hoạt động của người dùng này trên hệ thống.
          </p>
        </div>
